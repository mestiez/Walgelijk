...
namespace Typography.TextLayout
{
    ...
    public class GlyphLayout
    {
        ...
        public void Layout(IList<int> inputCodePoints, int startAt, int len)
        {
            ...
            for (int i = 0; i < end; ++i)
            {
                ...
                ushort glyphIndex = _typeface.GetGlyphIndex(cur_codepoint, next_codepoint);
        ...
        void Layout(GlyphIndexList glyphs)
        {
            ...
            for (int i = 0; i < finalGlyphCount; ++i)
            {
                ...
                //
                Glyph orgGlyph = _typeface.GetGlyphByIndex(glyphIndex);
            ...
            if (_scriptLang.scriptTag == s_math.scriptTag) //***
            {
                if (EnableBuiltinMathItalicCorrection)
                {
                    ...
                    {
                        Glyph glyph = _typeface.GetGlyphByIndex(_glyphPositions[i].glyphIndex);
    ...
    class GlyphPosStream : IGlyphPositions
    {
        ...
        {
            var r = GetGlyph(index, out short aa);
            advW = (ushort)aa;
            return r;
        }
    }
