...
public class Vec2Range : Range<Vector2>
{
    ...
    public static implicit operator Vec2Range(Vector2 value)
    {
        return new Vec2Range(value);
    }
}
...
public class ColorRange : Range<Color>
{
    ...
    public static implicit operator ColorRange(Color value)
    {
        return new ColorRange(value);
    }
}
