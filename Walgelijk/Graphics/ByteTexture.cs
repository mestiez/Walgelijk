...
{
    /// <summary>
    /// A texture that stores everything as bytes (RGBA) instead of colours.
    /// </summary>
    public class RawTexture : IReadableTexture
    {
        /// <summary>
        ...
        /// <summary>
        /// Whether the texture can store HDR image data. Will always return false for this object.
        /// </summary>
        ...
        /// </summary>
        public RawTexture(int width, int height, Color[] pixels, bool generateMipmaps = true)
        {
            Width = width;
            Height = height;
            RawData = new byte[pixels.Length * 4];
        ...
        /// <summary>
        /// Create a texture from a series of bytes
        /// </summary>
        public RawTexture(int width, int height, byte[] pixels, bool generateMipmaps = true)
        {
            Width = width;
            Height = height;
            this.RawData = pixels;
        ...
        /// </summary>
        public RawTexture(int width, int height, bool generateMipmaps = true)
        {
            Width = width;
            Height = height;
            this.RawData = null;
        ...
        /// </summary>
        public static RawTexture LoadTexture(string path, bool flipY = true, bool generateMipmaps = true)
        {
